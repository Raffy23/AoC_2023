use aoc_2023::{day01, day02, day03, day04, utils::read_input, utils::Part::Part1, day05, day06, day07};
...
fn day07_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("Day07 input parsing", |b| {
        b.iter(|| day07::parse_input(black_box(&input)))
    });

    c.bench_function("Day07 Part1", |b| {
        b.iter(|| day07::solve1(day07::parse_input(black_box(&input)).unwrap().1))
    });

    c.bench_function("Day07 Part2", |b| {
        b.iter(|| day07::solve2(day07::parse_input(black_box(&input)).unwrap().1))
    });
}